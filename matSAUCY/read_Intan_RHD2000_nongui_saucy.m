function [t_amplifier, t_board_adc, amplifier_data, board_adc_data, frequency_parameters] = read_Intan_RHD2000_nongui_saucy(intan_fname)
...
% save(strrep(intan_fname, '.rhd', '.mat'),...
%     'amplifier_channels',...
%     'amplifier_data',...
%     'board_adc_channels',...
%     'board_adc_data',...
